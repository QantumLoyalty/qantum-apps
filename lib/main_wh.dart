...
void main() async {
  FlavorConfig(
      flavor: Flavor.woollahra,
      flavorValues:
          FlavorValues(appName: "Woollahra Hotel", appVersion: "0.0.1"));
  ...
  SystemChrome.setPreferredOrientations(
    ...
    OneSignal.initialize("ce5a0772-bbbd-449f-a324-dd836665f9df");
    ...
    return MultiProvider(
      ...
      child: Portal(
        child: MaterialApp(
          ...
          theme: AppThemes.woollahraTheme,
