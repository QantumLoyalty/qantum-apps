...
class NotificationListTile extends StatefulWidget {
  ...
  final VoidCallback onTap;
   NotificationListTile({super.key,required this.notification,required this.onTap});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        leading: widget.notification.imageUrl != null && widget.notification.imageUrl!.isNotEmpty
            ? ClipRRect(
