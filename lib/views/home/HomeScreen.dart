...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    if (context.mounted) {
      ...
      Provider.of<HomeProvider>(context, listen: false).getAllOptionsTimer();
    }
  }
                    ...
                    Expanded(
                        ...
                        child: provider
                            ...
                            ConditionBuilder<Widget>.on(
                                    () =>
                                provider.homeNavigationList[provider
                                    .selectedOption]
                                    .type ==
                                    HomeNavigatorModel.typeScreen,
                                    () =>
                            ...
                            children: List.generate(3, (index) {
                              return Expanded(
                                  child: IconTextWidget(
                                    ...
                                    icon: provider.homeNavigationList[index]
                                        .icon,
                                    text: provider.homeNavigationList[index]
                                        .name
                                        .replaceAll(" ", "\n")
                                        .toUpperCase(),
                                    textColor: Theme
                                    ...
                                    onDragStart: (value) {
                                      ...
                                      if (provider.homeNavigationList[index]
                                          .name ==
                                          provider.homeNavigationList[0].name) {
                                        provider.updatePointsBalanceVisibility(
                                            false);
                                    ...
                                    onTapDown: (value) {
                                      ...
                                      if (provider.homeNavigationList[index]
                                        ...
                                        checkAndHidePointsBalance(provider, "FROM TOP ROW");
                                      }
                                    },
                                  ));
                            }),
                          ...
                          Row(
                            children: List.generate(4, (index) {
                              return Expanded(
                                  child: IconTextWidget(
                                    orientation: IconTextWidget.VERTICAL,
                                    icon: provider.homeNavigationList[index + 3]
                                        .icon,
                                    iconColor:
                                    (provider.homeNavigationList[index + 3]
                                        ...
                                        ? Colors.transparent
                                        : null,
                                    text: provider.homeNavigationList[index + 3]
                                        .name
                                        .replaceAll(" ", "\n")
                                        .toUpperCase(),
                                    margin: const EdgeInsets.all(5),
                                    ...
                                    onClick: () {
                                      ...
                                      /// HIDE & CHECK IF POINTS BALANCE MENU IS VISIBLE OR NOT
                                      checkAndHidePointsBalance(provider, "FROM SECOND ROW");


                                      if (provider.homeNavigationList[index + 3]
                                          .name !=
                                        ...
                                        if (provider.showSeeAllMenu == true &&
                                            (provider.homeNavigationList[index +
                                                3]
                                                .name !=
                                                provider.homeNavigationList[6]
                                                    .name)) {
  ...
  Widget checkForSeeAllMenu(HomeProvider provider) {
    ...
    return provider.showSeeAllMenu ? AllMenuItemsWidget() : Container();
