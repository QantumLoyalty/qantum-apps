...
void main() async {
  FlavorConfig(
      ...
      flavorValues: FlavorValues(appName: "North Shore Tavern", appVersion: "0.0.1"));
  ...
  SystemChrome.setPreferredOrientations(
    ...
    OneSignal.initialize("46320246-4a36-4fa6-8dc1-a9035c44403d");
    ...
    return MultiProvider(
      ...
      child: Portal(
          child: MaterialApp(
            ...
            theme: AppThemes.northShoreTheme,
