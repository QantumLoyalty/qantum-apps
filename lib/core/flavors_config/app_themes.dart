  ...
  static ThemeData get starRewardTheme => ThemeData(
        ...
        buttonTheme: ButtonThemeData(
            colorScheme: ColorScheme.fromSwatch()
                .copyWith(primary: AppColors.sr_button_color),
...
*/
        ...
        dividerColor: AppColors.sr_text_color,
  ...
  static ThemeData get sotTheme => ThemeData(
      ...
      textSelectionTheme: TextSelectionThemeData(
        ...
        cursorColor: AppColors.sot_text_color,
      ),
      buttonTheme: ButtonThemeData(
          colorScheme: ColorScheme.fromSwatch()
              .copyWith(primary: AppColors.sot_button_color),
...
*/
      ...
      dividerColor: AppColors.sot_text_color,
