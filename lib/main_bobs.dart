...
void main() async {
  FlavorConfig(
      ...
      flavorValues: FlavorValues(appName: "Bobs Bulk Booze", appVersion: "0.0.1"));
  ...
  SystemChrome.setPreferredOrientations(
    ...
    OneSignal.initialize("06fe23db-2318-4961-8be7-45a73f8a7941");
    ...
    OneSignal.Notifications.addForegroundWillDisplayListener((event) async {
      ...
      (
          '[OneSignal] FOREGROUND notification received: id=${n.notificationId}, title=${n.title}').logMessage();
